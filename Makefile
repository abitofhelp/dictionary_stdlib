...
help: ## Display this help message
	...
	@echo "  test               - Run compiled test suites (unit + integration)"
	@echo "  test-unit          - Run unit tests only"
	@echo "  test-integration   - Run integration tests only"
	@echo "  test-e2e           - Run E2E tests (starts server, requires port 8080)"
	@echo "  test-all           - Run compiled test suites (unit + integration)"
